...
st.sidebar.link_button(
    "🐙 GitHub Repository", 
    "https://github.com/littlepakan/PesPlanusMiniProject",  # ✏️ แก้ไขลิงก์ GitHub โปรเจกต์ตรงนี้
...
# ------------------------------------------
elif current_page == "ข้อมูลผู้พัฒนาโปรเจกต์":
...
# ------------------------------------------
elif current_page == "ใช้งานแอปพลิเคชัน":
    st.title("🔍 การพัฒนาเว็บแอปพลิเคชันเพื่อจำแนกโรคเท้าแบนจากภาพรังสีเอกซ์ด้วยตัวแบบการเรียนรู้ด้วยเครื่องและการเรียนรู้เชิงลึก (เวอร์ชั่นมินิโปรเจค)")
